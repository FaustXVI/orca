...
In case you encounter a term that you do not understand, please refer to [the O.R.CA documentation's glossary](https://eove.github.io/orca/v0.0.2/glossary.html)
...
A gpg-based one can be found in [the O.R.CA documentation](https://eove.github.io/orca/v0.0.2/gpg_public_key.html)
