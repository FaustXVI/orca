...
A gpg-based one can be found in [the O.R.CA documentation](https://eove.github.io/orca/v0.0.2)
...
If a word used in this document is unknown to you, the [O.R.CA documentation contains a glossary explaining key concepts](https://eove.github.io/orca/v0.0.2/glossary.html)
...
The process is detailed in [O.R.CA's documentation](https://eove.github.io/orca/v0.0.2/hardware_tokens.html).
...
> In such situations, you should immediately [revoke (and publish) the PEM that the offline vault just signed](https://eove.github.io/orca/v0.0.2/revocation.html). This requires running a new ceremony.
...
- Or you can create a brand new offline root CA.\
  ...
  Please read [the documentation on how to setup a new PKI](https://eove.github.io/orca/v0.0.2/pki_init.html).
