...
If a word used in this document is unknown to you, the [O.R.CA documentation contains a glossary explaining key concepts](https://eove.github.io/orca/unstable/glossary.html)
...
> In such situations, you should immediately [revoke (and publish) the PEM that the offline vault just signed](https://eove.github.io/orca/unstable/revocation.html). This requires running a new ceremony.
