...
This is made easy thanks to the fact O.R.CA offers [a way to test these scripts in VMs](https://eove.github.io/orca/v0.0.2/testing). On top of this, we heavily recommend to have a preproduction PKI to validate everything before running it on the production PKI.
